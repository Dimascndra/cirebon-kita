...
@section('subheader')
    @component('layouts.partials._breadcrumbs')
        ...
        @endslot
        @slot('action')
            <a href="{{ route('admin.jobs.create') }}" class="btn btn-primary font-weight-bolder">
                <i class="flaticon2-plus"></i> New Job
            </a>
        @endslot
    @endcomponent
@endsection
                        ...
                        <div class="card-title">
                            <h3 class="card-label mb-0">
                                ...
                                <span class="d-block text-muted font-size-sm mt-1">
                                    Manage job vacancies and listings
                                </span>
                            </h3>
                        </div>
                    ...
                    columns: [{
                        ...
                        template: function(row) {
                            return '<div><a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">' +
                                row.title + '</a></div>' +
                                '<div class="text-muted font-size-sm">' + (row.company ? row
                                    .company : '-') + '</div>';
                        }
                    }, {
                        field: 'company',
                        ...
                        autoHide: false,
                        template: function(row) {
                            return '<span class="text-muted font-weight-bold">' + row.location +
                                '</span>';
                        }
                    }, {
                        field: 'type',
                        ...
                        textAlign: 'center',
                        template: function(row) {
                            return '<span class="label label-light-info label-inline font-weight-bold">' +
                                row.type + '</span>';
                        }
                    }, {
                        field: 'status',
